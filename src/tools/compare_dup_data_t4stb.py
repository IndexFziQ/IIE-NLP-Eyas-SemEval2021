...
"""
@File    : compare_dup_data_t4stb.py
@Time    : 2020-11-11 10:35
@Author  : Yuqiang Xie
@Contact : indexfziq@gmail.com
"""
# Used for compare the dup data between train data set
# and trail/dev data set in sub-task B
...
input_file_train = os.path.join(data_dir, "training_data/Task_2_train.jsonl")
input_file_trail = os.path.join(data_dir, "trail_data/Task_2_Nonspecificity.jsonl")
input_file_dev = os.path.join(data_dir, "training_data/Task_2_dev.jsonl")
