...
def path_config(parser):
    ...
    path_group.add_argument("--trail_file", default=None, type=str)
...
def run_config(parser):
    ...
    run_group.add_argument("--label_smooth",
                           default=0.0,
                           type=float,
                           help="label smoothing, if set to 0.0 = close label smoothing. "
                                "Smoothed probability for each class = (label_smooth / (num_of_class - 1))"
                                "True class probability = 1 - label_smooth")
